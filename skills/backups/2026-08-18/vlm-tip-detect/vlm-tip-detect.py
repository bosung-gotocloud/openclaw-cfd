...
VL_PROMPT = "Find ALL wing tips, tail tips, canard tips, sharp convex points. Return ONLY JSON with double quotes: {\"tips\": [{\"tip_id\": N, \"x\": pixelX, \"y\": pixelY}, ...], \"image_width\": W, \"image_height\": H}"
