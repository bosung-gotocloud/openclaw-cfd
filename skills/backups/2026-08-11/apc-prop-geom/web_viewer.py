...
if '__file__' in dir():
    BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test")
else:
    BASE_DIR = os.path.join(os.path.dirname(os.path.abspath("/home/bosung/.openclaw/workspace/skills/apc-prop-geom")), "test")
