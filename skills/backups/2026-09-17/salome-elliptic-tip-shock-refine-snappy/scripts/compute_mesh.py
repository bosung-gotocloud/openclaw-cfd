...
def run_compute_mesh():
    ...
    if success:
        ...
        print("\n" + "="*60)
        print("WORKFLOW COMPLETE (snappyHexMesh + checkMesh pending)")
        print("="*60)
        print(f"\n  OpenFOAM case ready at: {case_dir}")
        print("\n  Next: Run snappyHexMesh to add viscous boundary layers")
        print("  (snappyHexMeshDict already configured with addLayers parameters)")
        print("="*60)
