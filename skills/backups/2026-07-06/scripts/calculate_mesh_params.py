...
def run_calculate():
    ...
    derived_rows = [
        ...
        ["surf_size (=20xT)", f"{surf_size:.6f} m", "= 20xT"],
    ...
    if tip_points:
        ...
        print(f"  Number of wake lines: {len(tip_points)}")
        ...
        print(f"\n[Tip Wake Lines]")
        print(f"  No tip points found -> Wake lines disabled")
    ...
    summary_rows = [
        ...
        ["surf_size", f"{surf_size:.6f} m", "20xT"],
        ["refine_local_size", f"{refine_local_size:.6f} m", "= max_size / 4"],
