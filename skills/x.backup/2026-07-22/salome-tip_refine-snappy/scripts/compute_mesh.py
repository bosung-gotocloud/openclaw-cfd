...
def run_compute_mesh():
    ...
    params.SetNbVolOptSteps(0)         # Volume optimization OFF (BFGS diverges at large h-ratio)
    params.SetOptimize(0)              # 3D tet optimization OFF (same reason)
    ...
    print("  > Surface optimization steps: 3")
    print("  > Volume optimization: DISABLED (large h-ratio)")
    print("  > 3D optimize: DISABLED (large h-ratio)")
    print("  > Second-order elements: DISABLED (linear)")
    print("  > Growth rate: 1.3")
