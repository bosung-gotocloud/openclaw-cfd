...
def run_compute_mesh():
    ...
    derived_rows = [
        ...
        ["min_size", f"{min_size:.6f} m", "T (BL total thickness)"],
    ...
    # Custom mesh quality params (enabled for Custom fineness):
    params.SetGrowthRate(0.3)           # Custom growth rate
    params.SetNbSegsPerEdge(1)           # Segments per edge
    params.SetNbSegsPerRadius(3)         # Segments per radius
