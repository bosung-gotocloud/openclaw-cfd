...
def setup_snappy_hex_mesh_case(base_dir, base_name, h1, growth, layers, template_dir):
    ...
    # finalLayerThickness 0.5 = 50% of local surface cell size (firstAndRelativeFinal mode)
...
""" % (num_procs, num_procs))
        ...
        # ---- Run snappyHexMesh in parallel via mpirun — 2026-09-10: setsid+nohup detach ----
